	public static Dictionary<Type, int[]> Damages = new Dictionary<Type, int[]>() 
		//[Injury Type], new int[]{[Headshot Damage], [Body Damage], <Stunning Time>(60unit/s)}
        {
	...
	public static Dictionary<Type, int[,]> SpecialDamages = new Dictionary<Type, int[,]>() 
		//[Injury Type], new int[N, 3]{[ChargeLevel-N Headshot Damage], [ChargeLevel-N Body Damage], [ChargeLevel-N Stunning Time](60unit/s)},
        {
